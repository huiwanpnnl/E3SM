...
readonly CASE_NAME="NCIC_macmic"$MACMIC"_"$COMPSET
...
# Set paths
readonly CHECKOUT="huis_public_e3sm_fork"
readonly CODE_ROOT="${SCRATCH}/vis/ncic/code/${CHECKOUT}"
readonly CASE_ROOT="${SCRATCH}/vis/ncic/cases/${CASE_NAME}"

# Sub-directories
readonly CASE_BUILD_DIR=${SCRATCH}/vis/ncic/build
...
! CondiDiag
!--------------------------------------------------------------------------------
!                         0.01-9.99/cc          10-30 /cc               > 50/cc
!--------------------------------------------------------------------------------
metric_name      =             'NCIC',             'NCIC',               'NCIC', 
metric_nver      =                 72,                72,                    72,
metric_cmpr_type =                  0,                 0,                     1,
metric_threshold =             5.00e6,             20.e6,                 50.e6,
metric_tolerance =             4.99e6,             10.e6,                    0.,
cnd_eval_chkpt   = 'ACTDIAG'${MACMIC}, 'ACTDIAG'${MACMIC}, 'ACTDIAG01'${MACMIC},
cnd_end_chkpt    =          'PBCDIAG',          'PBCDIAG',            'PBCDIAG',
!--------------------------------------------------------------------------------
...
qoi_name = 'NUMLIQ', 'CLDLIQ', 'NCIC', 'QCIC', 'AST', 'T', 'RHW', 'NPCCN'
qoi_nver =       72,      72,     72,      72,   72 , 72,     72,     72
